...
if __name__ == '__main__':
    print("Modified fine tune for", task, "with LR and BS: ", learning_rate, batch_size)
    ...
    pred_label = trainer.predict(predict_dataset).predictions[:, 0]
    ...
    df.index.name = 'index'
    df.to_csv("modified of " + task + ".tsv", sep="\t")
