...
if __name__ == '__main__':
    print("Modified fine tune for", task, "with LR and BS and RS: ", learning_rate, batch_size, random_seed)
    ...
    with open("RS_modified misclassification of " + task + str(random_seed) + ".txt", "w+") as f:
