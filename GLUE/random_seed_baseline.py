...
epoch = 3
batch_size = 64
learning_rate = 3.8734043111843074e-05
random_seed = 1337
...
if __name__ == '__main__':
    print("Baseline fine tune for", task, "with LR and BS and RS: ", learning_rate, batch_size, random_seed)
    ...
    with open("RS_baseline misclassification of " + task + str(random_seed) + ".txt", "w+") as f:
